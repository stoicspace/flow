...
exports.testRepair = testRepair;
function testRepair(workflow, operations) {
    const checks = [];
    for (const op of operations) {
        ...
        switch (op.type) {
            ...
            case "ADD_ERROR_HANDLER": {
                ...
                const edgeExists = workflow.edges.some(e => e.source === op.nodeId && e.target === op.handlerNodeId);
                checks.push({
